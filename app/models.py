...
from sqlalchemy import Column, Integer, String, Float, ForeignKey, TIMESTAMP, DateTime, func, Boolean  
...
class Produto(Base):
    ...
    estoque = Column(Integer, nullable=False)  # Adicionando o campo estoque
